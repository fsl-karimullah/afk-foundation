...
export default function ApplyGateway() {
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(180deg, var(--bg-primary) 0%, rgba(10,22,40,0.95) 100%)",
      }}
    >
      {/* Glow */}
      <div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 gap-3">
                {benefits.map((b) => (
                  ...
                  >
                    ...
                    <span className="text-[var(--slate-200)] text-sm font-medium">
                      {b.text}
                    </span>
                  </div>
                ))}
              ...
              <ul className="space-y-3">
                {requirements.map((r) => (
                  <li key={r} className="flex items-start gap-3">
                    ...
                    <span className="text-[var(--slate-300)] text-sm">{r}</span>
                  </li>
                ))}
              </ul>
            </div>
            ...
            >
              ...
              <div>
                <p className="text-white font-bold text-sm">Waktu Respons</p>
                <p className="text-[var(--slate-400)] text-xs mt-0.5">
          ...
          <div className="glass p-10 text-center relative overflow-hidden">
            <div className="absolute top-0 left-0 right-0 h-40 bg-gradient-to-b from-[rgba(16,185,129,0.08)] to-transparent pointer-events-none" />

            <div className="relative z-10">
              {/* Icon */}
              <div className="w-20 h-20 rounded-3xl bg-[rgba(16,185,129,0.15)] border border-[rgba(16,185,129,0.3)] flex items-center justify-center mx-auto mb-6">
              ...
              <p className="text-[var(--slate-400)] text-sm mb-8 leading-relaxed">
              ...
              <a
                ...
                className="btn-primary flex items-center justify-center gap-3 w-full px-8 py-5 rounded-2xl bg-[var(--emerald)] text-[var(--bg-primary)] font-black text-lg mb-4 hover:bg-[var(--emerald-light)] transition-all duration-300 hover:scale-[1.02] hover:-translate-y-0.5 shadow-xl shadow-[rgba(16,185,129,0.3)]"
              >
              ...
              <div className="mt-8 pt-8 border-t border-[var(--glass-border)]">
                <p className="text-[var(--slate-400)] text-sm mb-4">
                  Ingin kolaborasi, merekomendasikan seseorang, atau mendukung gerakan ini?
                </p>
                <a
                  id="support-btn"
                  href="mailto:hello@amirfaisalkarimullah.my.id"
                  className="flex items-center justify-center gap-2 w-full px-6 py-3.5 rounded-xl font-bold text-sm text-[var(--emerald)] border border-[rgba(16,185,129,0.3)] hover:border-[var(--emerald)] hover:bg-[rgba(16,185,129,0.08)] transition-all duration-300"
                >
